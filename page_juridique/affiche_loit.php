...
<h1>  Liste de tous les lois non validé </h1>
<?php  
...
$sql="SELECT * FROM publication WHERE type_veille = 'publication_juridique' AND statu = '0' ";
		$data=$bdd->query($sql);?>
		...
		<?php while($result = $data->fetch()){
			...
			echo "<td>".$result['date_ajout']."</td><td><a href='admin_juridique.php?page=4&supprime=".$result['id']."'>supprimé</a></td>";
